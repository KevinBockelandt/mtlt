    ...
    if (args.len > 2) {
        arg_parser.parse(args[2..]) catch |err| {
            switch (err) {
                ...
                argument_parser.ArgumentParsingError.CannotParseKickoffLess => return,
                argument_parser.ArgumentParsingError.KickoffLessAlreadyParsed => return,
                argument_parser.ArgumentParsingError.CannotParseKickoffMore => return,
                argument_parser.ArgumentParsingError.KickoffMoreAlreadyParsed => return,
